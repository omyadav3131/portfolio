...
import ProfileLight from "./../assets/profileDark.jpg"
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                >
                    ...
                    <motion.div
                        ...
                        className={`h-1.5 rounded-full mx-auto ${theme === "dark" ? "bg-[#b8f2e6]" : "bg-[#aed9e0]"
                            }`}
                    />
                </motion.div>
                ...
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    >
                        ...
                        >
                            ...
                            {/* Image container */}
                            <div className={`relative w-64 h-64 md:w-72 md:h-72 rounded-3xl overflow-hidden border-2 mx-auto ${theme === "dark"
