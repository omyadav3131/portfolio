  ...
  const certificationList = [
    {
      ...
      company: 'Indian Institute of Technology Roorke',
      period: 'Jan–Apr 2026',
      location: 'Online',
      type: 'Certificate',
      description: []
    },
    {
      ...
      company: 'Universal AI University',
      period: '2026',
      location: 'Hackathon',
      type: 'Certificate',
      description: []
    },
    {
      ...
      company: 'Shree Engineering Classes',
      period: '2025',
      location: 'Offline',
      type: 'Certificate',
      description: []
                ...
                <div className="mb-6">
                  ...
                  >
                    ...
                    <div className={`flex items-center gap-2 text-sm md:text-base ${
                      ...
                      <Award size={16} className={theme === 'dark' ? 'text-[#b8f2e6]' : 'text-[#aed9e0]'} />
                      <span>{cert.location}</span>
                    </div>
                    <div className={`flex items-center gap-2 text-sm md:text-base ${
                      theme === 'dark' ? 'text-[#aed9e0]' : 'text-[#5e6472]'
                    }`}>
                      <ExternalLink size={16} className={theme === 'dark' ? 'text-[#b8f2e6]' : 'text-[#aed9e0]'} />
                      <span>{cert.type}</span>
                    </div>
                  </motion.div>
                </div>
